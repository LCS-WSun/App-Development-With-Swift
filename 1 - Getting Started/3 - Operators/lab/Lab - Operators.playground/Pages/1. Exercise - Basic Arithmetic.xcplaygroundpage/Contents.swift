 ...
 */
let double0: Double = 10

let double3: Double = 3

let divisionResult = double0 / double3

print("3.3333333333")

print(" this differ from the value when using interger disvisions because in a interger it would not include decimal places so the answer would be 3 while in double it is 3.33333")
/*:
