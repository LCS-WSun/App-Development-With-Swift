 ...
 */
print("the code does not compile properly because we made friends into a constant which cannot change in value. If it was a variable, swift would have no problem of changing friend to 90")
